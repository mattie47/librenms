...
if ($vars['app'] == 'awplus-amf') {
    $vars['app'] = 'amf';
}

//print_r($vars);
//echo '<pre>' . var_dump($components) . '</pre>';
...
echo '<span style="font-weight: bold;">AMF Nodes</span> &#187; ';
...
?>
<table id='amf-table' class='table table-condensed table-responsive table-striped'>
    <thead>
    <tr>
        <th data-column-id="device">Device</th>
        <th data-column-id="role">Role</th>
        <th data-column-id="networkname">Network Name</th>
